...
const NewUserForm = () => {
    ...
    const validPwdClass = !validPassword ? "form_input--incomplet" : ""
    const validRolesClass = !Boolean(roles.length) ? "form_input--incomplet": " "
            ...
            <form className='form' onSubmit={onSaveUserClicked}>
                ...
                <input 
                 ...
                 <select 
                    name="roles" 
                    id="roles"
                    className={`from__select ${validRolesClass}`}
                    multiple={true}
                    size={3}
                    value={roles}
